...
public class AdministrationController {
	...
	@ResponseBody()
	public ResultVO selectAllLog(@RequestBody String SearchCriteria) {
		com.alibaba.fastjson.JSONObject jsonObject = JSON.parseObject(SearchCriteria);
//		Edu996 edu996 = JSON.toJavaObject(jsonObject, Edu996.class);
		String SearchCriteria2 = (String)jsonObject.get("SearchCriteria");
		com.alibaba.fastjson.JSONObject jsonObject2 = JSON.parseObject(SearchCriteria2);
		Edu996 edu996 = JSON.toJavaObject(jsonObject2, Edu996.class);
	...
	@ResponseBody
	public ResultVO endNewMUTime(@RequestParam String edu404Id,@RequestParam("userId") String userId) {
		// 将收到的jsonObject转为javabean 关系管理实体类
//		JSONObject jsonObject = JSONObject.fromObject(muTimeinfo);
//		Edu404 edu404 = (Edu404) JSONObject.toBean(jsonObject, Edu404.class);
		ResultVO result = administrationPageService.endNewMUTime(edu404Id,userId);
		return result;
	}
...
//	}
	...
	@ResponseBody
	public Object comfirmSchedule(@RequestParam("Edu201Id") String edu201Id,@RequestParam("scheduleDetail") String scheduleDetail,@RequestParam("scatteredClass") String scatteredClass,@RequestParam("sfpw") String sfpw) {
		Map<String, Object> returnMap = new HashMap();
		// 将收到的jsonObject转为javabean 关系管理实体类
...
//		}
	...
	@ResponseBody
	public Object reComfirmSchedule(@RequestParam("userId") String userId,@RequestParam("userName") String userName,@RequestParam("Edu202Id") String edu202Id,@RequestParam("scheduleDetail") String scheduleDetail,@RequestParam("scatteredClass") String scatteredClass,@RequestParam("sfpw") String sfpw) {
		Map<String, Object> returnMap = new HashMap();
		// 将收到的jsonObject转为javabean 关系管理实体类
		List<Edu203> edu203List = JSON.parseArray(scheduleDetail, Edu203.class);
		List<Edu207> edu207List = JSON.parseArray(scatteredClass, Edu207.class);
