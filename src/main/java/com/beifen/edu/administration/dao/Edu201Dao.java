...
//	@Query(value = "select * from Edu201 where class_id = ?1 and xnid = ?2 and sfypk='T' and sfsqks = 'T'", nativeQuery = true)
	@Query(value = "select * from edu201 where edu201_id in (select edu201_id from edu204 where edu300_id in ?1) and xnid = ?2 and sfypk='T' and sfsqks = 'T'", nativeQuery = true)
	List<Edu201> searchCourseByClasses(List<String> edu300_IDs, String trem);
	...
	@Query(value = "select * from edu201 where edu201_id in (select edu201_id from edu204 where edu300_id = ?1) and xnid = ?2 and sfypk='T' and sfsqks = 'T'", nativeQuery = true)
	List<Edu201> searchCourseByClassOnly(String edu300_ID,String xnid);
	...
	@Query(value = "select count(distinct kcmc) from edu201", nativeQuery = true)
	String findskmsByXbbm();
