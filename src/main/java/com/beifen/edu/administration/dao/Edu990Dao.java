...
public interface Edu990Dao extends JpaRepository<Edu990, Long>,JpaSpecificationExecutor<Edu990> {
	...
	//查询申请人信息
	@Query(value = "select DISTINCT d.BF990_ID,d.js,d.js_id,f.xm yhm,d.mm,d.scdlsj,to_char(d.yxkjfs) yxkjfs,d.user_key,d.deparment_ids,d.deparment_names from edu600 e, edu990 d,edu101 f where e.PROPOSER_KEY = d.BF990_ID and f.EDU101_ID = d.user_key", nativeQuery = true)
	@Nullable
