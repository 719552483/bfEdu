...
function drawChartArea(){
	...
	stuffloudoutuArea();
	stuffguanxituArea();
	stuff3DzhuzhuangtuArea();
	stuff3DsandiantuArea();
}
...
//漏斗图1
function stuffloudoutuOne(){
	var myChart = echarts.init(document.getElementById("loudoutuOne"));
	option = {
		title: {
			text: '基础漏斗图',
			textStyle: {
...
//漏斗图2
function stuffloudoutuTwo(){
	var myChart = echarts.init(document.getElementById("loudoutuTwo"));
	option = {
		title: {
			text: 'PART漏斗图',
			textStyle: {
...
//漏斗图3
function stuffloudoutuThree(){
	var myChart = echarts.init(document.getElementById("loudoutuThree"));
	option = {
		title: {
			text: '对比漏斗图-1',
			textStyle: {
...
//漏斗图4
function stuffloudoutuFour(){
	var myChart = echarts.init(document.getElementById("loudoutuFour"));
	option = {
		title: {
			text: '对比漏斗图-2',
			textStyle: {
...
//渲染3D柱状图区域
function stuff3DzhuzhuangtuArea(){
	stuff3DzhuzhuangtuOne();
	stuff3DzhuzhuangtuTwo();
}

//3D柱状图1
function stuff3DzhuzhuangtuOne() {
	var myChart = echarts.init(document.getElementById("3DzhuzhuangtuOne"));

	var hours = ['12a', '1a', '2a', '3a', '4a', '5a', '6a',
		'7a', '8a', '9a','10a','11a',
		'12p', '1p', '2p', '3p', '4p', '5p',
		'6p', '7p', '8p', '9p', '10p', '11p'];
	var days = ['数据1', '数据2', '数据3',
		'数据4', '数据5', '数据6', '数据7'];
...
//3D柱状图2
function stuff3DzhuzhuangtuTwo(){
	var myChart = echarts.init(document.getElementById("3DzhuzhuangtuTwo"));
...
//渲染3D散点图区域
function stuff3DsandiantuArea(){
	stuff3DsandiantuOne();
}

//3D散点图1
function stuff3DsandiantuOne(){
	var myChart = echarts.init(document.getElementById("3DsandiantuOne"));
...
function chartListener(){
	...
	window.addEventListener("resize", function() {
		...
		var loudoutuOne = echarts.init(document.getElementById('loudoutuOne'));
		loudoutuOne.resize();
		var loudoutuTwo = echarts.init(document.getElementById('loudoutuTwo'));
		loudoutuTwo.resize();
		var loudoutuThree = echarts.init(document.getElementById('loudoutuThree'));
		loudoutuThree.resize();
		var loudoutuFour = echarts.init(document.getElementById('loudoutuFour'));
		loudoutuFour.resize();

		var zhuzhuangtu3DOne = echarts.init(document.getElementById('3DzhuzhuangtuOne'));
		zhuzhuangtu3DOne.resize();
		var zhuzhuangtu3DTwo = echarts.init(document.getElementById('3DzhuzhuangtuTwo'));
		zhuzhuangtu3DTwo.resize();

		var sandiantu3DOne = echarts.init(document.getElementById('3DsandiantuOne'));
		sandiantu3DOne.resize();
	});
}
